<%@ Page Title="Profile" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="KMinds.Portal.Web.UserProfile" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <section aria-labelledby="account-heading">
      <div class="profile-header">
        <div class="avatar" id="profile-avatar">
          <asp:Image ID="ProfileImage" runat="server" Visible="false" style="width:100%;height:100%;object-fit:cover;border-radius:50%;" />
          <span id="avatar_initials" runat="server"><asp:Literal ID="InitialsLiteral" runat="server"></asp:Literal></span>
        </div>
      ...
      <asp:MultiView ID="ProfileMultiView" runat="server" ActiveViewIndex="0">
        <asp:View ID="ViewMode" runat="server">
          ...
          <asp:Button ID="EditProfileButton" runat="server" Text="Edit Profile" OnClick="EditProfileButton_Click" CssClass="btn btn-secondary" style="margin-top:1.5rem;" />
        </asp:View>
        <asp:View ID="EditMode" runat="server">
          <div class="form-container" style="display:flex;flex-direction:column;gap:1.25rem;margin-top:1.5rem;">
            <div class="form-group">
                <label>Full Name</label>
                <asp:TextBox ID="EditFullName" runat="server" required="true"></asp:TextBox>
            </div>
            <div class="form-row">
              <div class="form-group">
                  <label>Department</label>
                  <asp:TextBox ID="EditDept" runat="server"></asp:TextBox>
              </div>
              <div class="form-group">
                  <label>Year-Term</label>
                  <asp:TextBox ID="EditYearTerm" runat="server"></asp:TextBox>
              </div>
            </div>
            <div class="form-group">
                <label>Roll Number</label>
                <asp:TextBox ID="EditRoll" runat="server"></asp:TextBox>
            </div>
            <div class="form-group">
                <label>Profile Picture (optional)</label>
                <div class="image-upload-area" id="profile-edit-upload">
                  <asp:FileUpload ID="EditProfileImageUpload" runat="server" accept="image/*" />
                  <div class="upload-icon">📷</div>
                  <p>Click or drag to upload new photo</p>
                  <img class="image-preview" src="" alt="Profile preview" />
                </div>
            </div>
            <div style="display:flex;gap:1rem;">
                <asp:Button ID="SaveProfileButton" runat="server" Text="Save Changes" OnClick="SaveProfileButton_Click" CssClass="btn btn-primary" />
                <asp:Button ID="CancelEditButton" runat="server" Text="Cancel" OnClick="CancelEditButton_Click" CssClass="btn btn-secondary" formnovalidate="true" />
            </div>
          </div>
        </asp:View>
      </asp:MultiView>
    ...
    <section aria-labelledby="payment-status-heading">
      ...
      <asp:PlaceHolder ID="PaymentUpdateFormPlaceholder" runat="server">
